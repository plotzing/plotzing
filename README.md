...
To save animations, users may use the **'anim_sav()**' command built into gganimate or the **'save_animation()**' command built into Plotzing. However, this latter command is still under development and does not yet support height and width commands.
